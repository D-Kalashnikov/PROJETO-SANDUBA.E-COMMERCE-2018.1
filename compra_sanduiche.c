...
{
  int compra = 1, ok = 0, escolha, esgotado = 0, num = 10;
  float somatorio = 0;
  Sanduiche sanduiche;
  ...
  while(compra == 1)
  {
    ...
    {
      somatorio = somatorio + ((sanduiche.recheio.valorv + sanduiche.molho.valorv + sanduiche.queijos.valorv + sanduiche.pao.valorv) * 1.8);
    }
